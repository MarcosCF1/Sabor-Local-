...
import 'verificacao_codigo_de_recuperacao_de_senha_model.dart';
export 'verificacao_codigo_de_recuperacao_de_senha_model.dart';

class VerificacaoCodigoDeRecuperacaoDeSenhaWidget extends StatefulWidget {
  const VerificacaoCodigoDeRecuperacaoDeSenhaWidget({
    super.key,
    required this.email,
  });
  ...
  static String routeName = 'VerificacaoCodigoDeRecuperacaoDeSenha';
  static String routePath = '/verificacaoCodigoDeRecuperacaoDeSenha';

  @override
  State<VerificacaoCodigoDeRecuperacaoDeSenhaWidget> createState() =>
      _VerificacaoCodigoDeRecuperacaoDeSenhaWidgetState();
}

class _VerificacaoCodigoDeRecuperacaoDeSenhaWidgetState
    extends State<VerificacaoCodigoDeRecuperacaoDeSenhaWidget> {
  late VerificacaoCodigoDeRecuperacaoDeSenhaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => VerificacaoCodigoDeRecuperacaoDeSenhaModel());
              ...
              Container(
                ...
                child: Stack(
                  children: [
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (_model.pinCodeController!.text ==
                            ...
                            context.pushNamed(
                              AtualizacaoRecuperacacaoSenhaWidget.routeName,
                              queryParameters: {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Algo deu errado...'),
                                  content: Text(
                                      'O código inserido está errado, por favor tente novamente.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
                    ...
                    Align(
                      alignment: AlignmentDirectional(0.16, 0.32),
                      child: InkWell(
                        splashColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        hoverColor: Colors.transparent,
                        ...
                        onTap: () async {
                          ...
                          if ((_model.apiResultc7?.succeeded ?? true)) {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Erro ao enviar o código!'),
                                  content: Text(
                                      'Verifique novamente as informações, o código não foi enviado'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
