                      ...
                      child: Column(
                        ...
                        children: [
                          Stack(
                            children: [
                              Align(
                                alignment: AlignmentDirectional(-9.83, -1.11),
                                child: Padding(
                              ...
                              Align(
                                alignment: AlignmentDirectional(-0.8, 0.72),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 400.0, 0.0, 0.0),
                                  child: Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await showModalBottomSheet(
                                        ...
                                        backgroundColor: Color(0x8014181B),
                                        enableDrag: false,
                                        context: context,
                                        builder: (context) {
                                          return GestureDetector(
                              ...
                              Align(
                                alignment: AlignmentDirectional(-0.19, 0.0),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 500.0, 0.0, 0.0),
                                  child: Text(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.checkboxValue!) {
                                        ...
                                        _model.apiResultc7l =
                                            await SendGridEmailVerificacaoCall
                                                .call(
                                          to: _model.textController2.text,
                                          content:
                                              'Bem vindo ${_model.textController1.text} ao Sabor Local! Aqui está o seu código de verificação: ${FFAppState().Codigo}',
                                          from: _model.from,
                                          subject:
                                              'Código de verificação Sabor Local',
                                        );

                                        if ((_model.apiResultc7l?.succeeded ??
                                            true)) {
                                          context.pushNamed(
                                            VerificadaoDeEmailETelefoneWidget
                                                .routeName,
                                            queryParameters: {
