...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    projetoSaborLocalAuthUserSubject.add(
      ProjetoSaborLocalAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ProjetoSaborLocalAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ProjetoSaborLocalAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ProjetoSaborLocalAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    projetoSaborLocalAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ProjetoSaborLocalAuthUser? currentUser;
